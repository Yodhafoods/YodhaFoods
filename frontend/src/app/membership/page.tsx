                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-8">
                    ...
                    <div className="flex-1 text-center lg:text-left z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            ...
                            <Link href="/shop" className="px-8 py-4 rounded-xl font-bold text-lg text-gray-700 border-2 border-gray-200 hover:border-orange-200 hover:bg-orange-50 transition-all flex items-center gap-2 justify-center">
                                Explore Store
                            </Link>
                        </div>
                    </div>
                ...
                <div className="bg-orange-600 rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            ...
                            />
                            <button type="submit" className="bg-gray-900 cursor-pointer text-white px-8 py-4 rounded-xl font-bold hover:bg-black transition-colors shadow-lg">
                                Subscribe
                            </button>
                        </form>
                    </div>
