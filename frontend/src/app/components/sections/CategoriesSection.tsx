...
export default function CategoriesSection() {
    ...
    return (
        <section className="mb-20 mt-12 relative group/section">
            <div className="flex justify-between items-baseline mb-6 px-1">
                <h2 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Top Categories</h2>
                {/* View All link hidden on mobile as they can swipe, visible on desktop check */}
                <Link href="/shop" className="text-sm font-bold text-orange-600 hover:text-orange-700 flex items-center gap-1 transition-colors">
