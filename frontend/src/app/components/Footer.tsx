    ...
    return (
        <footer className="bg-white text-gray-900 border-t border-gray-200 pt-16 pb-12 font-sans">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
                ...
                <div className="md:col-span-3 flex flex-col gap-6 text-left items-start">
                    <div className="flex flex-col gap-2 items-start">
                        ...
                        <p className="text-sm font-bold text-orange-700 italic tracking-wide">
                    ...
                    <div className="text-sm text-gray-700 font-medium flex flex-col gap-3 mt-2 leading-relaxed">
                        <div className="flex items-start gap-3 justify-start">
                            <MapPin size={18} className="shrink-0 mt-0.5 text-gray-900" />
                            <div>
                                <p className="font-bold text-lg text-gray-900">Yodha Foods Pvt Ltd</p>
                                <p>Phase-8, Industrial Area,</p>
                                <p>JP Nagar, Bengaluru, Karnataka, 560078</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 justify-start">
                            ...
                            <a href="tel:+919705883899" className="hover:text-orange-700 transition font-bold">
                                +91 9705883899
                            </a>
                        </div>
                    </div>
                ...
                <div className="md:col-span-6 flex flex-col items-center text-center">
                    <div className="max-w-md w-full flex flex-col items-center p-8 bg-gray-100 rounded-2xl border border-gray-100">
                        ...
                        <div className="flex gap-6 mb-6">
                            ...
                            <SocialLink href="#" icon={<FaYoutube size={22} />} label="YouTube" />
                            <SocialLink href="#" icon={<FaLinkedinIn size={18} />} label="LinkedIn" />
                            <SocialLink href="#" icon={<FaFacebookF size={18} />} label="Facebook" />
                        </div>

                        {/* Legal Links */}
                        <div className="flex gap-4 text-xs text-gray-500 font-bold flex-wrap justify-center uppercase tracking-wide">
                            <Link href="#" className="hover:text-orange-700 transition">Terms & Conditions</Link>
                            <span className="hidden sm:inline text-gray-300">•</span>
                            <Link href="#" className="hover:text-orange-700 transition">Privacy Policy</Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-[1440px] mx-auto px-6 mt-12 pt-6 border-t border-gray-200 text-center text-xs font-semibold text-gray-500">
                <p>&copy; {new Date().getFullYear()} Yodha Foods Private Limited. All rights reserved.</p>
            </div>
        </footer>
    );
};
...
const FooterLink = ({ href, children }: { href: string; children: React.ReactNode }) => (
    <Link href={href} className="text-gray-700 hover:text-orange-700 hover:translate-x-0 md:hover:translate-x-1 transition-all duration-200 inline-block w-fit">
        {children}
    </Link>
);
